...
When you get a token from your Authorization Server, which will look like this:
...
Jwk jwk = provider.get("RkI5MjI5OUY5ODc1N0Q4QzM0OUYzNkVGMTJDOUEzQkFCOTU3NjE2Rg"); //throws Exception when not found or can't get one
```
